...
const PILLARS = [
  ...
  { icon: '', label: 'Qualified Vets',    desc: 'All vets are registered professionals within partner hospitals.' },
...
export default function StatsBand() {
  ...
  return (
    <section style={{ background: '#3a2c2d' }} className="py-20 px-4 md:px-8">
      <div
        ref={ref}
        ...
        {PILLARS.map(p => (
          <div key={p.label}>
            ...
            <div
              ...
              style={{ color: 'rgba(219,232,216,.55)' }}
            >
              {p.desc}
            </div>
          </div>
